...
<head>
    ...
    <title>Masuk — Talenta Santri</title>
...
<body class="min-h-screen bg-cloud flex items-center justify-center p-4">
    <div x-data="loginPage" class="w-full max-w-sm">
        ...
        <form @submit.prevent="submit" class="card p-6 space-y-4">
            <h1 class="font-display font-bold text-xl mb-1">Masuk</h1>
            <p class="text-sm text-ink/50 mb-4">Masuk pakai akun santri kamu.</p>
            ...
            <div>
                ...
                <input type="email" x-model="email" required placeholder="santri@sekolah.sch.id"
            ...
            <p class="text-center text-sm text-ink/50">
                Belum punya akun? <a href="/register" class="text-brand-blue font-medium">Daftar</a>
            </p>
        </form>
    </div>
</body>
