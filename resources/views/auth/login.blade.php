    ...
    <div x-data="authSwitcher()" class="w-full h-full relative overflow-hidden flex">
        ...
        <div class="absolute inset-0 w-full h-full flex items-center z-20 pointer-events-none p-4 sm:p-6 lg:p-10"
            ...
            <div class="w-full md:w-1/2 h-full flex items-center justify-center pointer-events-auto">
                ...
                <div class="w-full max-w-[480px] max-h-[92vh] bg-white rounded-[24px] p-6 sm:p-10 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.15)] border border-slate-100/90 flex flex-col justify-center my-auto transition-all duration-500 ease-in-out transform"
                    ...
                    <template x-if="displayMode === 'login'">
                        <div>
                            <img src="{{ asset('images/landing/logo.svg') }}" alt="Talent Mapping" class="h-12 mx-auto mb-6">
                            <div class="text-center space-y-2 mb-6 sm:mb-8">
                                <h1 class="text-3xl sm:text-4xl font-bold text-[#FBBF24] leading-tight">Selamat Datang 👋</h1>
                            ...
                            <form @submit.prevent="submitLogin" class="space-y-4 sm:space-y-5">
                                <div>
                                    ...
                                    <input type="email" x-model="loginData.email" required placeholder="Masukan Email kamu."
                                           class="w-full h-11 sm:h-12 rounded-xl border border-slate-300 px-4 text-sm sm:text-base text-slate-800 placeholder:text-slate-400 placeholder:italic font-medium focus:outline-none focus:ring-2 focus:ring-[#5B50E5] focus:border-transparent transition-all shadow-xs">
                                </div>
                                <div>
                                ...
                                <div class="pt-1 sm:pt-3">
                                    <button type="submit" :disabled="loading" 
                                        ...
                                        <span x-show="!loading">Ayo kita mulai!</span>
                    ...
                    <template x-if="displayMode === 'register'">
                        <div>
                            ...
                            <div class="text-center space-y-2 mb-5 sm:mb-6">
                                <h1 class="text-3xl sm:text-4xl font-bold text-[#FBBF24] leading-tight">Sign Up</h1>
                                <p class="text-sm sm:text-base font-normal text-slate-800">
