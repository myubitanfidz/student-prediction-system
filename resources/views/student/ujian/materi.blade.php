...
@php
    ...
    $materiConfig = [
        'arab' => [
            'label'        => 'Arabic',
            'photo'        => asset('images/landing/materi/arabicCard.jpg'),
            'placeholder'  => false,
            'highlight'    => '#FDCB6E',
            'headline_pre' => 'Selamat datang di tempat',
            'headline_hi'  => 'satu bahasa membuka banyak kesempatan',
            'description'  => "Bahasa Arab adalah bahasa yang digunakan untuk memahami berbagai sumber keislaman. Dengan mempelajarinya, kamu dapat memahami makna yang terkandung di balik setiap ayat secara lebih mendalam.",
            'benefits'     => 'Membuka pintu ke ranah global, memperluas akses informasi dan literatur dunia, serta membekali kamu dengan berbagai budaya dan menangkap peluang akademik maupun karier di tingkat internasional.',
            'apps_label'   => 'Cara Belajar',
            'apps_color'   => '#00CEC9',
            'apps'         => ['Al-Maany', 'Duolingo', 'Translate', 'Tashreef'],
        ],
        'inggris' => [
            'label'        => 'English',
            'photo'        => asset('images/landing/materi/englishCard.jpg'),
            'placeholder'  => false,
            'highlight'    => '#FDCB6E',
            'headline_pre' => 'Selamat datang di tempat',
