...
<div class="max-w-6xl mx-auto space-y-6">
    <div class="flex justify-between items-center bg-white p-6 rounded-xl shadow-sm border border-line">
        <div>
            ...
            <p class="text-sm text-ink/50">Tambah paket ujian dan atur butir-butir soalnya.</p>
        </div>
    ...
    <div class="bg-white rounded-xl max-w-md w-full p-6 space-y-4 shadow-xl">
        ...
        <form id="createExamForm" class="space-y-3">
            ...
            <div class="flex justify-end space-x-2 pt-2">
                <button type="button" onclick="toggleModal(false)" class="px-4 py-2 border border-line rounded-lg text-sm">Batal</button>
        ...
        try {
            ...
            tbody.innerHTML = result.data.map(exam => `
                <tr class="hover:bg-slate-50/50">
                    <td class="p-4 font-semibold text-brand-blue">${exam.category}</td>
